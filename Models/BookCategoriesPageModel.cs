...
namespace Ciuta_Andreea_laborator2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Ciuta_Andreea_laborator2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Ciuta_Andreea_laborator2Context context,
